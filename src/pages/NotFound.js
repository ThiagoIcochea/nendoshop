  ...
  return (
    ...
    >
      <main className="flex-grow relative z-10 flex flex-col lg:flex-row items-center justify-center px-4 gap-8 lg:gap-4">
        ...
        <div className="flex-shrink-0 w-full lg:w-1/2 flex items-center justify-center lg:justify-end animate__animated animate__fadeInLeft">
          <img
            src={E404}
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left animate__animated animate__fadeInRight">

          <div className="mb-8">
            <h1 className="text-5xl sm:text-6xl font-bold text-brand mb-4 tracking-tight animate__animated animate__fadeInDown">
              ¡ERROR 404!
            </h1>

            <p className="text-xl sm:text-2xl text-gray-700 font-medium leading-relaxed animate__animated animate__fadeInUp">
              Esta página está{" "}
          ...
          <div className="mt-12 flex flex-col lg:flex-row gap-4 lg:gap-6 justify-center lg:justify-start animate__animated animate__fadeInUp animate__delay-1s">
      ...
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-brand opacity-5 rounded-full blur-3xl pointer-events-none animate__animated animate__pulse animate__infinite" />
    </div>
  );
}